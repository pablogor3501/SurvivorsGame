...
const unsigned char PerlinNoise::HASH[] = {
...
double PerlinNoise::linInter(double x, double y, double s)
{
    return x + s * (y - x);
}

double PerlinNoise::smoothInter(double x, double y, double s)
{
...
double PerlinNoise::noise2D(double x, double y)
{
    ...
    return smoothInter(
        smoothInter(s, t, x_frac),
        smoothInter(u, v, x_frac),
        y_frac
    );
}
